...
parser.add_argument('--model_name', default='UncertaintyLoss')
...
parser.add_argument('--theta', type=float, default=2.0, help='hyper-parameter')
...
if __name__ == "__main__":
    ...
    train_dataloader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, num_workers=16) #16
    val_dataloader = DataLoader(val_set, batch_size=1, shuffle=False, num_workers=16)
    test_dataloader = DataLoader(test_set, batch_size=1, shuffle=False, num_workers=16) #16
